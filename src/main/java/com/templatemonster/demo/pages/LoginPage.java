...
public class LoginPage extends BasePage {
    private By LOGIN_FORM_SUBMIT_BUTTON_LOCATOR = By.xpath("//button[contains(.,'Log in')]");
    private By USER_LOGIN_INPUT_LOCATOR = By.xpath("//input[@type='email']");
    private By USER_PASSWORD_INPUT_LOCATOR =By.xpath("//input[@type='password']");
    ...
    public LoginPage fillLoginFormWithAnyCredentials(String login, String password) {
        ...
        $(USER_LOGIN_INPUT_LOCATOR).sendKeys(Keys.RETURN);
